...
var file_janus_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x75, 0x73, 0x72, 0x70, 0x63, 0x22, 0x30, 0x0a, 0x12, 0x53, 0x69, 0x6e, 0x67, 0x6c,
	...
	0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x22, 0x2e, 0x0a, 0x14, 0x4d, 0x75, 0x6c,
	...
	0x65, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x65, 0x73, 0x32, 0xf1, 0x01, 0x0a, 0x0c, 0x4a, 0x61,
...
var file_janus_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_janus_proto_depIdxs = []int32{
	...
	0, // 1: janusrpc.JanusService.GetState:input_type -> janusrpc.SingleStateRequest
	0, // 2: janusrpc.JanusService.StreamState:input_type -> janusrpc.SingleStateRequest
	1, // 3: janusrpc.JanusService.GetNodeStates:input_type -> janusrpc.MultipleStateRequest
	2, // 4: janusrpc.JanusService.GetState:output_type -> janusrpc.StateResponse
	2, // 5: janusrpc.JanusService.StreamState:output_type -> janusrpc.StateResponse
	3, // 6: janusrpc.JanusService.GetNodeStates:output_type -> janusrpc.MultipleStateResponse
